...
var UIManager = { 
  ...
  createTimer: function(){
    ...
    this.timeLabel = game.add.text(game.world.centerX, 100, "00:00", {font: "50px Arial", fill: "#ccc"}); 
  ...
  deleteCurrentItem: function(item){
    item.kill();
  }
...
//Phaser Core
    ...
    create: function(){
        ...
        game.state.start("levelOneState"); //Switch to Main
    },
//Helpers
