...
var UIManager = {
  ...
  showCorrectCircle: function(numOfResponses) {
    ...
    var increment = 50;
    var positionX = 0;
    console.log("Attempts: " + Session.itemAttemps);
  ...
  showIncorrectCircle: function(numOfResponses) {
    ...
    var increment = 50;
    var positionX = 0;
    // If not first try && not first response
    ...
    // This is the first try
      ...
      if(numOfResponses === 0) {
        ...
        //if not first item but still first try
      } else if(numOfResponses > 0){
...
LevelOneSummary.prototype = {
    ...
    create: function() {
        ...
        //game.add.text(game.world.centerX + 80,  560, LevelData.timeBonus, {font: "25px Arial", fill: "#fff"});
...
//PRELOAD
  loadLevelItems: function() {
    ...
    if(Session.items.length < 1) {
      alert("Network connection lost, please refresh or move to a location with a better connection");
    }
  },
//CREATE
  ...
  setupSprites: function() {
    //Display Static Assets
        ...
        var recycleBinSprite = game.add.sprite(330,570, "recycleBinImage");
        var paperBinSprite = game.add.sprite(630,570, "paperBinImage");
        var garbageBinSprite = game.add.sprite(930,570, "garbageBinImage");
        ...
        UIManager.displayEmptyBlueCircles();
        //Timing
        timerBar = new Phaser.Rectangle(260, 35, 120, 25);
        timerBarContainer = game.add.sprite(253, 30, "timerBarContainer");
        //Audio
        audioToggle = game.add.sprite(1100, 35, "audioToggle");
        audioToggle.inputEnabled = true;
        audioToggle.events.onInputDown.add(UIManager.toggleAudio);
        audioOn = true; //TODO: Change global scope pls
  ...
  checkLevelComplete(nextState) {
    //Check if level is completed, flag is set in Session Manager
      if(Session.levelCompleteFlag == true){
          ...
          if(GameData.allResponses === undefined) {
            GameData.allResponses = Session.responses;
          } else {
            Array.prototype.push.apply(GameData.allResponses, Session.responses);
          }
          console.log(GameData.allResponses);
