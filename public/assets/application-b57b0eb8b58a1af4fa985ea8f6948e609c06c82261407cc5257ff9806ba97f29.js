...
//Helpers
    loadStaticAssets: function(){
      ...
      game.load.audio("themeMusic", "/assets/game/themeMusic.mp3");
    },
...
//Phaser Core Functions
    ...
    //Timer
        Session.startTime_date = new Date();
...
//Phaser Core Functions
    ...
    update: function() {
      ...
      if(Session.levelCompleteFlag == true){
          ...
          APIManager.postResponses(Session.responses)
          SessionManager.clearSession();
          game.state.start('levelTwoSummary', Phaser.Plugin.StateTransition.Out.SlideTop, Phaser.Plugin.StateTransition.In.SlideTop);
      }
    },
    //Callback on overlap, checked on update()
    collisionCallback: function(obj1, obj2){
