...
var StatsManager = {
  ...
  computeLevelData: function (levelSession) {
    ...
    LevelData.timeSpent = LevelData.levelTime;
    //Calculate correct, incorrect 
    levelSession.responses.forEach(function callback(currentResponse, index, array) {
    ...
    LevelData.totalPoints = this.computeScore(LevelData.numberOfCorrect, LevelData.numberOfIncorrect, 120-LevelData.timeSpent);
...
// 
        ...
        var levelOneButtonSprite = game.add.sprite(50,30, "levelOneButton");
