...
var StatsManager = {
  ...
  computeLevelData: function (levelSession) {
    ...
    console.log("correct game " + GameData.numberOfCorrect);
  ...
  computeScore: function(numCorrect, numIncorrect, timeRemaning){
    console.log("time timeRemaning" + timeRemaning);
...
//Helpers
    ...
    //Construct bins from bin model in bin.js. Name is suffixed with image due to Sprite references only having this name.
        var recycle_bin  = new Bin(1, "recycleBinImage");
        var garbage_bin  = new Bin(2, "garbageBinImage");
