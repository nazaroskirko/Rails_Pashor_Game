...
var StatsManager = {
  ...
  computeScore: function(numCorrect, numIncorrect, timeRemaning){
    ...
    return numCorrect*5 + timeRemaning;
  }
}
;
...
//Helpers
    loadStaticAssets: function(){
      ...
      game.load.audio("correctSound", "/assets/game/CorrectSound.mp3");
      game.load.audio("incorrectSound", "/assets/game/IncorrectSound.mp3");
    },
