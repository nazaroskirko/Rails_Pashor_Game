...
var StatsManager = {
  ...
  computeLevelData: function (levelSession) {
    ...
    console.log(LevelData.levelTime);
...
//Helpers
    loadStaticAssets: function(){
      ...
      game.load.image("levelTwoButton","https://s3.ca-central-1.amazonaws.com/sorting-items/static-assets/Level3Button.png");
      //Clock
...
//Phaser Core Functions
    ...
    if(Session.levelCompleteFlag == true){
        ...
        // //game.state.start("levelTwoSummary");
        // APIManager.postResponses(Session.responses)
